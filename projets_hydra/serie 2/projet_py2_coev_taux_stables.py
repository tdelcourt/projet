...
def execution():
	...
	# sauvegarde en print
	#liste_resultats=[parameter_list]	#initialisation liste resultats a liste de parametres.
	...
	listelogs=[sys.argv[2] for i in range(nesppatho)]
	...
	fitness_hotes=[def_fitness_hotes for i in range(nh)]
	
	
	repro_pathos=[[def_fitness_hotes for patho in range(maxpathos)] for espece in range(nesppatho)]
	...
	for gene_hote in range(generation_hote):
		...
		for gene_patho in range(generation_patho):
			...
			fitness_pathos=[[[def_fitness_patho for i in range(3)] for patho in range(maxpathos)] for espece in range(nesppatho)]
...
#def print_repro_pathos(nesppatho, maxpathos, repro_pathos,sommes_repro_especes,population_patho,population_patho_enfant,sommes_repro_especes_pathos,sommes_repro_especes_pathos_cum):
	...
	#for espece in range(nesppatho):
		#print (espece)
		#print("no patho	repro	(patho_parent, patho_enft)	somme_repro	somme_repro_cum")
		#for patho in range(maxpathos):
